...
def get_proxy_infos(*args, **kwargs):
    ...
    cookie = 'proxy_cookie' in kwargs and kwargs['proxy_cookie'] or hasattr(settings, 'PROXY_COOKIE') and settings.PROXY_COOKIE or None
    return (domain, port, user, password, cookie)
